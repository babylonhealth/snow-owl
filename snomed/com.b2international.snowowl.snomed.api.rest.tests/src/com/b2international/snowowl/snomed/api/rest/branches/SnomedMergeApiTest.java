...
public class SnomedMergeApiTest extends AbstractSnomedApiTest {
	...
	private void assertRelationshipCanBeUpdated(final IBranchPath branchPath, final String symbolicName, final Map<?, ?> requestBody) {
	...
	private void assertRelationshipCanBeDeleted(IBranchPath branch, String symbolicName) {
